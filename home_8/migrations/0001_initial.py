    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.ImageField(blank=True, upload_to='home_8/image')),
                ('slide', models.ImageField(blank=True, upload_to='home_8/slide')),
                ...
                ('blog_photo', models.ImageField(blank=True, upload_to='home_8/blogs_images')),
                ('time', models.DateField(blank=True)),
                ('name', models.CharField(blank=True, max_length=255)),
                ('icons', models.ImageField(blank=True, upload_to='home_8/icons/')),
            ],
            options={
                'verbose_name': 'Home_8',
